...
def test_render_text():
    ...
    RenderText.of(
        text, "/mnt/c/Windows/Fonts/times.ttf", 24, shading=Palette.WHITE
    ).render().save(out / "test_new_render_text.png")
    ...
    RenderText.of(text, font_with_fallback, 24, shading=Palette.WHITE).render().save(
